...
class AdminController extends Controller
{
    ...
    public function delfaqAction($id, $page)
    {
        ...
        return $this->redirect($this->generateUrl('nao_admin_faq', array(
            'faq'   => $faqs,
            'nbPages' => $nbPages,
            'page' => $page
        )));
    ...
    public function newfaqAction($page, Request $request)
    {
        ...
        return $this->render('NAOFaqBundle:Admin:new.html.twig', array(
            'faq' => $faq,
    ...
    public function majfaqAction($id, Request $request)
    {
        ...
        return $this->render('NAOFaqBundle:Admin:article.html.twig', array(
            'faq' => $faq,
            'form' => $form->createView()
        ));
    }
