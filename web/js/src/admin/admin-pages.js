(function () {
    ...
    let buttons = document.querySelectorAll('section .btn:not(.btn--large), button');
    let icons = document.querySelectorAll('.navbar-mobile-content .icon, section .icon, section .icon--large, .comments .icon, .blog-title .icon, .observation-container .icon, .observation-container .icon--large');
